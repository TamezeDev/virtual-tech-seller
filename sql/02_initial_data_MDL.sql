...
INSERT INTO products(id_product, name, description, base_price, url_image, available, id_category) VALUES
    ...
    (8, 'Final Fantasy VII', 'Remake Intergrade & Rebirth PS5', 28.45, '/img/products/FinalFantasyVII.jpg', TRUE, 2),
    ...
    (12, 'TP-Link ARCHER TX50E', 'Tarjeta de red, AX3000, Wi-Fi 6, Bluetooth 5.0 PCIe, Negro', 23.57, '/img/products/TarjetaRed.jpg', TRUE, 3),
    ...
    (17, 'Xbox Series S', 'MICROSOFT EP2-00644, 1 TB, Blanco', 350.44, '/img/products/xboxS.jpg', TRUE, 4),
...
INSERT INTO users(id_user, name, last_name, email, password, phone, rol, email_activate, credit, created_date) VALUES
    (1, 'Lucia', 'Morales Ruiz', 'admin1@virtualtechseller.com', '$2a$12$UKnIZWYRF0031TElnNpfHuixt/xphb9KC3HdlJMyqemJl5L1ZSb/W', '600111111', 'ADMIN', TRUE, 0.00, '2026-01-10'), -- DEFAULT PASSWORD: Admin-123
    (2, 'Carlos', 'Jimenez Soto', 'admin2@virtualtechseller.com', '$2a$12$UKnIZWYRF0031TElnNpfHuixt/xphb9KC3HdlJMyqemJl5L1ZSb/W', '600111112', 'ADMIN', TRUE, 0.00, '2026-01-11'), -- DEFAULT PASSWORD: Admin-123
    (3, 'Marta', 'Serrano Gil', 'moderator1@virtualtechseller.com', '$2a$12$8l.GZq56.QuO9KhNuqu5BOrzeL7p38Ypl3Fl0yOznrj2dWHoLuOi.', '600111113', 'MODERATOR', TRUE, 0.00, '2026-01-12'), -- DEFAULT PASSWORD: Moderator-123
    (4, 'Paco', 'García Lopez', 'client1@virtualtechseller.com', '$2a$12$1hrlxwUGJgoYtWIWjLpY2eJZTPtYLMgf2vVUUvadaTl3WX20YibhO', '600111114', 'CLIENT', TRUE, 300.00, '2026-01-15'), -- DEFAULT PASSWORD: Client-123
    (5, 'Laura', 'Navarro Perez', 'client2@virtualtechseller.com', '$2a$12$1hrlxwUGJgoYtWIWjLpY2eJZTPtYLMgf2vVUUvadaTl3WX20YibhO', '600111115', 'CLIENT', TRUE, 180.00, '2026-01-18'), -- DEFAULT PASSWORD: Client-123
    (6, 'David', 'Romero Cruz', 'client3@virtualtechseller.com', '$2a$12$1hrlxwUGJgoYtWIWjLpY2eJZTPtYLMgf2vVUUvadaTl3WX20YibhO', '600111116', 'CLIENT', TRUE, 520.00, '2026-01-20'), -- DEFAULT PASSWORD: Client-123
    (7, 'Paula', 'Mendez Lara', 'client4@virtualtechseller.com', '$2a$12$1hrlxwUGJgoYtWIWjLpY2eJZTPtYLMgf2vVUUvadaTl3WX20YibhO', '600111117', 'CLIENT', TRUE, 95.00, '2026-01-21'), -- DEFAULT PASSWORD: Client-123
    (8, 'Sergio', 'Vega Martin', 'client5@virtualtechseller.com', '$2a$12$1hrlxwUGJgoYtWIWjLpY2eJZTPtYLMgf2vVUUvadaTl3WX20YibhO', '600111118', 'CLIENT', TRUE, 410.00, '2026-01-23'), -- DEFAULT PASSWORD: Client-123
    (9, 'Andrea', 'Castro Ruiz', 'client6@virtualtechseller.com', '$2a$12$1hrlxwUGJgoYtWIWjLpY2eJZTPtYLMgf2vVUUvadaTl3WX20YibhO', '600111119', 'CLIENT', FALSE, 150.00, '2026-01-25'), -- DEFAULT PASSWORD: Client-123
    (10, 'Javier', 'Ortega Leon', 'client7@virtualtechseller.com', '$2a$12$1hrlxwUGJgoYtWIWjLpY2eJZTPtYLMgf2vVUUvadaTl3WX20YibhO', '600111120', 'CLIENT', TRUE, 260.00, '2026-01-28'); -- DEFAULT PASSWORD: Client-123
...
INSERT INTO sales(id_sale, id_user, id_exhibition, id_product, quantity, total_price, purchase_date) VALUES
    ...
    (2, 4, 2, 3, 1, 1220.23, '2026-03-08'),
    (3, 5, 2, 5, 1, 60.89, '2026-03-02'),
    (4, 5, 2, 3, 1, 6.45, '2026-03-04'),
    (5, 6, 1, 2, 2, 130.68, '2026-03-09'),
    (6, 6, 1, 3, 1, 100.50, '2026-03-10'),
    (7, 7, 2, 9, 1, 28.45, '2026-03-06'),
    (8, 8, 4, 2, 1, 303.65, '2026-03-11'),
    (9, 8, 1, 4, 1, 200.12, '2026-03-12'),
    (10, 9, 4, 6, 1, 350.44, '2026-03-13'),
    (11, 9, 1, 8, 2, 20.24, '2026-03-15'),
    (12, 10, 2, 5, 1, 50.03, '2026-03-07'),
    (13, 10, 1, 3, 1, 6.50, '2026-03-16');
